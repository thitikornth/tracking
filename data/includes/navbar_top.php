            ...
            <ul class="navbar-nav ml-auto">
                ...
                ?>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="login/profile.php">
                                <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                Profile
                            </a>
                            <a class="dropdown-item" href="login/active_log.php">
                                <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                                Activity Log
                            </a>
                            <form action="" method="get">
                                <div class="dropdown-divider"></div>
                                <button class="dropdown-item" name="logouted">
                    ...
                    <div class="topbar-divider d-none d-sm-block"></div>
                    <li class="nav-item ">
                        <a class="nav-link" href="login/login_02.php">
                            <span class="btn btn-danger d-lg-inline"><i class="fas fa-lock "></i> Admin Only </span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="login/login.php">
                            ...
                            <span class="btn btn-success d-lg-inline "><i class="fas fa-list fas fa-sign-out-alt "></i> User Login </span>
                        </a>
                    </li>
                <?php
                }
